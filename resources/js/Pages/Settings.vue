...
<template>
    <AppLayout>
        <div class="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
            <Breadcrumb current-page="Settings" page-title="User Settings" />
                ...
                <div
                    ...
                    <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                        <img class="mb-4 rounded-lg w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0"
                            :src="$page.props.auth.user.profile_photo_url" alt="Jese picture">
                        <div>
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                <label for="first-name"
                                    ...
                                    Name</label>
                                <input type="text" name="first-name" id="first-name" :value="$page.props.auth.user.name"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Bonnie" required="" readonly>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="last-name"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="email" name="email" id="email" :value="$page.props.auth.user.email"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="example@company.com" required="" readonly>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <div data-popover="" id="popover-password" role="tooltip"
                                    ...
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate(865px, -1768px);"
